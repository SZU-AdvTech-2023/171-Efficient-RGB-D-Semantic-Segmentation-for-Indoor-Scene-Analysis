...
from src.models.model_utils import ConvBNAct, Swish, Hswish, LeakyReLU, PReLU, ELU, SELU
    ...
    def __init__(self,
        ...
        if activation.lower() == 'relu':
            ...
            raise NotImplementedError(
                'Only relu, swish, hswish, leakyrelu, prelu, elu and selu '
                'as activation function are supported so far. Got {}'.format(activation))
